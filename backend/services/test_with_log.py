...
log_file = open(os.path.join(script_dir, "verification_test.log"), "w", encoding="utf-8")
sys.stdout = log_file
sys.stderr = log_file
...
try:
    ...
    print(f"Testing verification for: {test_image}\n")
...
print("Log written to verification_test.log")
