...
import { UnmatchedEmailsView } from "../dashboard/UnmatchedEmailsView";
...
export function DashboardView() {
    ...
    return (
        <div className="space-y-6 pb-12 w-full max-w-[1600px] mx-auto">
                ...
                <div className="flex bg-slate-900/50 p-1 rounded-2xl border border-slate-800">
                    <button
                        ...
                        className={cn(
                            ...
                            view === "clients" ? "bg-indigo-600 text-white shadow-lg shadow-indigo-500/20" : "text-slate-400 hover:text-white"
                        )}
                    >
                        Clients
                    </button>
                    <button
                        ...
                        className={cn(
                            ...
                            view === "unmatched" ? "bg-indigo-600 text-white shadow-lg shadow-indigo-500/20" : "text-slate-400 hover:text-white"
                        )}
                    >
            ...
            {/* Content areas with view switcher */}
                                        ...
                                        <table className="w-full text-left text-sm text-slate-400 border-collapse whitespace-nowrap">
                                            <thead>
                                                <tr className="bg-slate-900/80 uppercase text-[11px] font-bold text-slate-500 tracking-wider">
                                                    ...
                                                    <th className="px-4 py-4 border-b border-slate-800">Email</th>
                                                ...
                                                {clients.map((loan, idx) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="px-4 py-4">
                                                                <div className="flex flex-col">
                                                                    <span className="text-white text-xs">{loan.email || "-"}</span>
                                                                </div>
                                                            </td>
                                                            <td className="px-4 py-4">
